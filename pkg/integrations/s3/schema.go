			...
			},
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:         "delimiter",
						Name:        "Delimiter",
						Description: "Character used to group keys. Default is '/' for directory-style listing",
						Required:    false,
						Type:        domain.NodePropertyType_String,
						Placeholder: "/",
					},
					{
						Key:         "fetch_owner",
						Name:        "Fetch Owner",
						Description: "Include owner information for each object in the result",
						Required:    false,
					...
					},
					{
						...
						Description: "Token from a previous request to continue listing",
						Required:    false,
						Type:        domain.NodePropertyType_String,
					},
					{
						Key:         "start_after",
						Name:        "Start After",
						Description: "Key to start listing after (for pagination)",
						Required:    false,
						Type:        domain.NodePropertyType_String,
					},
					{
						Key:         "encoding_type",
						Name:        "Encoding Type",
						Description: "Encoding type for object keys in response",
						Required:    false,
						Type:        domain.NodePropertyType_String,
					...
					{
						Key:         "expected_bucket_owner",
						Name:        "Expected Bucket Owner",
						Description: "Account ID of the expected bucket owner for access verification",
						Required:    false,
						Type:        domain.NodePropertyType_String,
					},
					{
						Key:         "request_payer",
						Name:        "Request Payer",
						Description: "Confirms that the requester will pay for the request",
						Required:    false,
						Type:        domain.NodePropertyType_String,
						Options: []domain.NodePropertyOption{
							{
