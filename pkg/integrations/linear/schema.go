...
var (
	...
	schema domain.Integration = domain.Integration{
		...
		Name:              "Linear",
		Description:       "Use Linear integration to create, read, update, and delete issues, add comments, attach links, and manage your team's workflow.",
		...
		Triggers: []domain.IntegrationTrigger{
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:              "resource_types",
						Name:             "Resource Types",
						Description:      "Select the types of Linear resources to listen for.",
						Required:         true,
						...
						Options: []domain.NodePropertyOption{
							...
							},
							{
								...
								Value:       "Attachment",
								Description: "Files and links attached to issues",
							},
							{
								Label:       "Issue Labels",
								Value:       "IssueLabel",
							...
							},
							{
								...
								Value:       "ProjectUpdate",
								Description: "Status updates posted to projects",
							},
						},
		...
		Actions: []domain.IntegrationAction{
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:          "state_id",
						Name:         "Initial Status",
						Description:  "The initial workflow status of the issue (e.g., 'Backlog', 'Todo').",
						Required:     false,
						Type:         domain.NodePropertyType_String,
						Peekable:     true,
			...
			},
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:         "limit",
						Name:        "Limit",
						Description: "Maximum number of issues to retrieve (default 50, max 100).",
						Required:    false,
			...
			},
			{
				...
				Description: "Adds a comment to an existing Linear issue.",
				Properties: []domain.NodeProperty{
					{
						Key:         "issue_id",
						Name:        "Issue ID",
			...
			},
			{
				...
				ActionType:  IntegrationActionType_AddLink,
				Description: "Adds a URL link as an attachment to a Linear issue.",
				Properties: []domain.NodeProperty{
					{
						Key:         "issue_id",
						Name:        "Issue ID",
						Description: "The ID of the issue to add the link to.",
						Required:    true,
						Type:        domain.NodePropertyType_String,
					},
					{
					...
					},
					{
						Key:         "title",
						Name:        "Link Title",
						Description: "Optional title for the link attachment.",
						Required:    false,
						Type:        domain.NodePropertyType_String,
					},
				},
