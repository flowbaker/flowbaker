	...
	schema domain.Integration = domain.Integration{
		...
		Actions: []domain.IntegrationAction{
			...
			},
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:         "columns",
						Name:        "Columns",
						Description: "Map item fields to table columns",
						Required:    true,
						...
						ArrayOpts: &domain.ArrayPropertyOptions{
							...
							ItemProperties: []domain.NodeProperty{
								...
								},
								{
									Key:         "value",
									Name:        "Value",
									Description: "Value or expression (e.g., {{item.name}})",
									Type:        domain.NodePropertyType_String,
									Required:    true,
								},
							},
			...
			},
			{
				...
				Properties: []domain.NodeProperty{
					...
					},
					{
						Key:         "columns",
						Name:        "Columns",
						Description: "Map item fields to columns to update",
						Required:    true,
						Type:        domain.NodePropertyType_Array,
						ArrayOpts: &domain.ArrayPropertyOptions{
							ItemType: domain.NodePropertyType_Map,
			...
			},
			{
				ID:          "select",
				Name:        "Select",
				ActionType:  IntegrationActionType_Select,
				Description: "Select data from a Snowflake table",
				Properties: []domain.NodeProperty{
					{
						Key:          "table",
						Name:         "Table",
					...
					},
					{
						Key:         "columns",
						Name:        "Columns",
						Description: "Columns to select (leave empty for all columns)",
						Required:    false,
						Type:        domain.NodePropertyType_Array,
						ArrayOpts: &domain.ArrayPropertyOptions{
							ItemType: domain.NodePropertyType_Map,
					...
					},
					{
						Key:         "conditions",
						Name:        "Conditions",
						Description: "WHERE clause conditions (leave empty for all rows)",
						Required:    false,
						Type:        domain.NodePropertyType_Array,
						ArrayOpts: &domain.ArrayPropertyOptions{
							ItemType: domain.NodePropertyType_Map,
